import { PatientTableDataServer } from "@/api/patients/patients";

export const mockCaregiverID: number = 1;

export const mockPatientTDList: PatientTableDataServer = {
  patients: [
    {
      id: 1,
      name: "Alice Johnson",
...
const getPatientNameList = (): string[] => {
  return mockPatientTDList.patients.map((p) => p.name);
};
