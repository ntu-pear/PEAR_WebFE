...
export const mockScheduledPatientActivities: ScheduledPatientActivity[] = [
  { id: 's1', activityTemplateId: 'a1', patientId: '1', patientName: 'Alice', date: '2025-07-28', startTime: '09:00', endTime: '10:00', isOverridden: false, isExcluded: false },
  { id: 's2', activityTemplateId: 'a3', patientId: '1', patientName: 'Alice', date: '2025-07-28', startTime: '12:00', endTime: '13:00', isOverridden: false, isExcluded: false },
  { id: 's3', activityTemplateId: 'a2', patientId: '2', patientName: 'Bob', date: '2025-07-28', startTime: '10:30', endTime: '11:30', isOverridden: false, isExcluded: false },
  { id: 's4', activityTemplateId: 'a6', patientId: '1', patientName: 'Alice', date: '2025-07-29', startTime: '14:00', endTime: '16:00', isOverridden: false, isExcluded: false },
  { id: 's5', activityTemplateId: 'a4', patientId: '2', patientName: 'Bob', date: '2025-07-29', startTime: '09:30', endTime: '10:30', isOverridden: false, isExcluded: false },
  { id: 's6', activityTemplateId: 'a1', patientId: '1', patientName: 'Alice', date: '2025-07-30', startTime: '09:00', endTime: '10:00', isOverridden: false, isExcluded: false },
  { id: 's7', activityTemplateId: 'a3', patientId: '1', patientName: 'Alice', date: '2025-07-30', startTime: '12:00', endTime: '13:00', isOverridden: false, isExcluded: false },
  { id: 's8', activityTemplateId: 'a2', patientId: '2', patientName: 'Bob', date: '2025-07-30', startTime: '10:30', endTime: '11:30', isOverridden: false, isExcluded: false },
  { id: 's9', activityTemplateId: 'a5', patientId: '1', patientName: 'Alice', date: '2025-08-01', startTime: '11:00', endTime: '12:00', isOverridden: true, notes: 'Supervisor adjusted time', isExcluded: false },
  { id: 's10', activityTemplateId: 'a1', patientId: '2', patientName: 'Bob', date: '2025-08-01', startTime: '09:00', endTime: '10:00', isOverridden: false, isExcluded: true, exclusionReason: 'Patient feeling unwell' }, // Example of excluded
  
  // Add some activities that span multiple time slots for testing
  { id: 's21', activityTemplateId: 'a6', patientId: '1', patientName: 'Alice', date: '2025-08-18', startTime: '16:30', endTime: '17:30', isOverridden: false, isExcluded: false }, // Within new time range
  { id: 's22', activityTemplateId: 'a4', patientId: '2', patientName: 'Bob', date: '2025-08-18', startTime: '09:15', endTime: '09:45', isOverridden: false, isExcluded: false }, // Within 9:00 slot
];
