      ...
      {calendarDays.map((dayDate, index) => {
        ...
        return (
          ...
          >
            ...
            <div className="flex flex-col space-y-1 overflow-hidden h-[calc(100%-28px)]">
              {dayActivities.slice(0, 3).map((activity) => {
                ...
                return (
                  <div
                    key={activity.id}
                    className={`rounded-sm px-2 py-1 text-xs truncate ${ACTIVITY_STYLES.baseActivity} ${ACTIVITY_STYLES.fontColour} cursor-pointer hover:opacity-80 transition-opacity ${
