...
const Navbar: React.FC = () => {
  const initialNotifications = [
    ...
    {
      id: 2,
      avatar: "https://images.unsplash.com/photo-1531427186611-ecfd6d936c79?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=634&q=80",
      name: "Slick Net",
    ...
    {
      id: 3,
      avatar: "https://images.unsplash.com/photo-1450297350677-623de575f31c?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=334&q=80",
      name: "Jane Doe",
    ...
    {
      id: 4,
      avatar: "https://images.unsplash.com/photo-1580489944761-15a19d654956?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=crop&w=398&q=80",
                  ...
                  >
                    <div className="py-2">
                      {notifications.length > 0 ? (
                        ...
                        <p className="text-gray-600 text-center py-4 text-primary">No notifications</p>
                      )}
                    </div>
                    {notifications.length > 0 && (
                      <button
