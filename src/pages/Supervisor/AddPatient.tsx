        ...
        <form onSubmit={handleSubmit}>
          <div className="space-y-12">
            ...
            <div id="personal-info" className="border-b-2 border-border pb-12">
              ...
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div className="col-span-full">
                  <label
                    htmlFor="patient-temporary-postal-code"
                    className="block text-sm font-medium leading-6 text-primary"
                  >
            ...
            <div id="guardian-info" className="border-b-2 border-border pb-12">
              ...
              <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div className="col-span-full">
                  <label
                    htmlFor="guardian-temporary-postal-code"
                    className="block text-sm font-medium leading-6 text-primary"
                  >
                    Temporary Postal Code
                  </label>
              ...
              {showSecondaryGuardian && (
                <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                  ...
                  <div className="sm:col-span-2">
                    <label
                      htmlFor="secondary-guardian-first-name"
                      className="block text-sm font-medium leading-6 text-primary"
                    >
                  ...
                  <div className="sm:col-span-2">
                    <label
                      htmlFor="secondary-guardian-last-name"
                      className="block text-sm font-medium leading-6 text-primary"
                    >
                  ...
                  <div className="col-span-full">
                    <label
                      htmlFor="secondary-guardian-postal-code"
                      className="block text-sm font-medium leading-6 text-primary"
                    >
                      Postal Code <span className="text-red-500 ml-1">*</span>
                    </label>
                  ...
                  <div className="col-span-full">
                    <label
                      htmlFor="secondary-guardian-temporary-postal-code"
                      className="block text-sm font-medium leading-6 text-primary"
                    >
                      Temporary Postal Code
                    </label>
            ...
            <div id="allergies" className="border-b-2 border-border pb-12">
              ...
              <p className="mt-1 text-sm leading-6 text-primary">
                Add Patient's allergies (if any)
              </p>
          ...
          focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:max-w-xs sm:text-sm sm:leading-6`}
                        >
                          ...
                          <option value="Abdominal cramp or pain">
